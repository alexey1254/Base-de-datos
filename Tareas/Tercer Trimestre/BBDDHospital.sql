...
VALUES
(7369,'SANCHEZ','EMPLEADO',7902,'1980-12-19',10400,0,20),
(7499,'ARROYO','VENDEDOR',7698,'2002/02/20',208000,39000,30),
(7521,'SALA','VENDEDOR',689,'2020/02/21',162500,65000,30),
(7566,'JIMENEZ','DIRECTOR',7839,'2020/04/21',386750,0,20),
(7654,'MARTIN','VENDEDOR',7698,'2020/09/21',182000,182000,30),
(7698,'NEGRO','DIRECTOR',7839,'2020/05/21',370500,0,30),
(7782,'CEREZO','DIRECTOR',7839,'2021/06/21',318500,0,10),
(7788,'NINO','ANALISTA',7566,'2022/03/13',390000,0,20),
(7839,'REY','PRESIDENTE',0,'2020/11/21',650000,0,10),
(7844,'TOVAR','VENDEDOR',7698,'2021/09/21',195000,0,30),
(7876,'ALONSO','EMPLEADO',7788,'2020/05/13',143000,0,20),
(7900,'JIMENO','EMPLEADO',7698,'2022/12/21',123500,0,30),
(7902,'FERNANDEZ','ANALISTA',7566,'2020/12/21',390000,0,20),
(7934,'MUÑOZ','EMPLEADO',7782,'1999/06/15',169000,0,10),
(7119,'SERRA','DIRECTOR',7839,'2020/11/23',225000,39000,20),
(7322,'GARCIA','EMPLEADO',7119,'2000/10/15',129000,0,20);
...
(45,4,1280,'Am R.','Interino','N',221000),
...
(22,2,9901,'Nóez C.','Interino','M',221000);
# Insertar datos en la tabla Enfermo
INSERT INTO Enfermo(Inscripcion,Apellido,Direccion,Fecha_Nac,S,NSS)
VALUES
(10995,'Lagua M.','Goya 20','2002-06-21','M',280862422),
(14024,'Fernández M.','Recoletos 50','2001-06-02','F',284991452),
(18004,'Serrano V.','Alcalá 12','2002-06-2002','F',321790059),
(36658,'Domin S.','Mayor 71','2002-04-23','M',160654471),
(38702,'Neal R.','Orense 11','2001-08-20','F',380010217),
(39217,'Cervantes M.','Perón 38','2000-09-01','M',440294390),
(59076,'Miller B.','López de Hoyos 2','2003-02-02','F',311969044),
(63827,'Ruiz P.','Ezquerdo 103','1999-08-20','M',100973253),
(64823,'Fraiser A.','Soto 3','2001-06-23','F',285201776),
(74835,'Benítez E.','Argentina','2001-07-24','M',154811767);